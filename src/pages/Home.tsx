...
import MarqVid from "../../public/vids/marquee.mp4"
...
export const Home = () => {
    ...
    return (
        <div className="">
            {/* first container */}
            <div className="m-12 mt-[80px] flex flex-col-reverse md:flex-row lg:flex-row">
                {/* texts */}
                <div className="mt-8 md:mt-0 lg:mt-0 w-full md:w-[60%] lg:w-[60%]">
                    <h1 className="text-xl lg:text-[40px] lg:leading-[66px] font-bold">Turn Human Enterprise into Expert AI Agents</h1>
                    <p className="text-base lg:text-[18px] lg:leading-[28px] mt-[20px] text-[#CECECE]">Netra Lab's <strong>Ground Truth®</strong> is the <strong>world's first Enterprise Language Chain</strong> framework for building and deploying Expert <strong>AI Agents™</strong> into production, at scale.</p>
                ...
                <div className="w-full md:w-[40%] lg:w-[40%]">
                    <div className="w-full md:w-[70%] lg:w-[70%] flex justify-center items-center mx-auto">
                        <video
            ...
            {/* second container */}
            <div className="p-10 second-container flex flex-col-reverse justify-center items-center md:flex-row lg:flex-row">
                <div className="w-full mt-8 md:mt-0 lg:mt-0 md:w-[60%] lg:w-[60%]">
                    <video
                    ...
                    <h1 className="text-xl lg:text-[40px] lg:leading-[66px] font-bold mt-[26px]">To simplify the complexity of Generative AI.</h1>
                    <p className="text-base lg:text-[18px] lg:leading-[28px] mt-[20px] text-[#CECECE]">Ground Truth® simplifies AI Agent development with an intuitive drag-and-drop interface, enabling rapid creation of complex agentic workflows.</p>
                    {/* lists */}
                    <div className="mt-[40px] flex flex-col gap-[18px] text-[#B1B1B1]">
                        <div className="flex items-center gap-3">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div className="text-base lg:text-[18px] lg:leading-[49px]">Integrate with <span className="text-accent">ANY MODEL</span>, with no limitations.</div>
                        </div>

                        <div className="flex items-center gap-3">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div className="text-base lg:text-[18px] lg:leading-[49px]">Easily craft prompts that guide your agent to <span className="text-accent">ACT ON YOUR DATA</span>exactly as you need.</div>
                        </div>

                        <div className="flex items-center gap-3">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div className="text-base lg:text-[18px] lg:leading-[49px]">Connect and synchronize with your existing tools and systems for a <span className="text-accent">UNIFIED WORKFLOW</span>.</div>
                        </div>
                    </div>
                </div>
            ...
            {/* third container */}
            <div className="p-10 flex flex-col justify-center items-center third-container">
                <video
                ...
                <h1 className="text-xl lg:text-[40px] lg:leading-[66px] text-center mt-[26px] font-bold">Solve Real Business Problems with Expert AI Agents™ Tailored to Your Needs</h1>
                <div className="btn btn-accent rounded-sm mt-[35px] hover:cursor-pointer" onClick={() => navigate("/contact-us")}>Request Demo</div>
                {/* cards */}
                <div className="flex w-full mt-[90px]">
                    ...
                    {/* middle */}
                    <div className="lang-card-bottom flex items-center justify-center text-center p-10 w-[70vw] border border-white">
            ...
            <div className="p-10 ">
                <div className="">
                    ...
                    <h1 className="text-xl lg:text-[40px] lg:leading-[66px] mt-[26px] font-bold">Ensure Enterprise grade reliability and governance.</h1>
                    <p className="text-base lg:text-[18px] lg:leading-[28px] mt-[20px] text-[#CECECE]">Enterprises demand security and accountability, the <span className="uppercase text-accent text-[18px] font-bold leading-[28px]">Ground Truth® Framework</span> delivers with enterprise-grade control mechanisms:</p>
                </div>
                <div className="flex items-center gap-[40px] flex-col md:flex-row lg:flex-row mt-[20px]">
                    ...
                    <div className="flex flex-col gap-[40px] text-[#CECECE] w-full md:w-[60%] lg:w-[60%] mt-[20px] md:mt-0 lg:mt-0">
                        <div className="flex items-center gap-3 glass-card-1">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div><span className="uppercase text-accent text-[18px] font-bold leading-[28px]">Enterprises demand security and accountability,</span> the Ground Truth® framework delivers with enterprise-grade control mechanisms:</div>
                        </div>
                        <div className="flex items-center gap-3 glass-card-2">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div>Our unique Validation mode enables <span className="uppercase text-accent text-[18px] font-bold leading-[28px]">the debugging and optimization</span> of your agentic workflows.</div>
                        </div>
                        <div className="flex items-center gap-3 glass-card-3">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div><span className="uppercase text-accent text-[18px] font-bold leading-[28px]">Guarantee security by deploying</span> agents in your environment, using your data.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="p-10">
                ...
                <video
                    ...
                    <h1 className="text-xl lg:text-[40px] lg:leading-[66px] font-bold mt-[26px]">And endless scaling possibilities for your AI Agents.</h1>
                    <p className="text-base lg:text-[18px] lg:leading-[28px] mt-[20px] text-[#CECECE]">The Ground Truth® framework excels in the orchestration of complex agentic workflows, providing actual clarity around usage.</p>
                </div>
                <div className="flex justify-between mt-[20px] md:mt-0 lg:mt-0 items-center flex-col md:flex-row lg:flex-row">
                    <div className="flex flex-col gap-[40px] text-[#CECECE]  w-full md:w-[60%] lg:w-[60%] mt-[20px] md:mt-0 lg:mt-0">
                        <div className="flex items-center gap-3 glass-card-1">
                                <div className="badge badge-secondary badge-xs"></div>
                                <div><span className="uppercase text-accent text-[18px] font-bold leading-[28px]">Track your token consumption and monitor usage</span> simultaneously across all agentic workflows.</div>
                        </div>
                        <div className="flex items-center gap-3 glass-card-2">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div>
                                Extract insights from diverse sources through <span className="uppercase text-accent text-[18px] font-bold leading-[28px]"></span>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 glass-card-3">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div>
                                Agents that <span className="uppercase text-accent text-[18px] font-bold leading-[28px]">operate asynchronously,</span> ensuring tasks are executed without waiting for sequential order.
                            </div>
                        </div>
                    </div>
                    <div className="w-full md:w-[40%] lg:w-[40%] flex justify-center items-center">
            ...
            <div className="p-10">
                <div className="text-center">
                    <h1 className="text-xl lg:text-[40px] lg:leading-[66px] font-bold mt-[26px]">Built for Business</h1>
                    <p className="text-base lg:text-[18px] lg:leading-[28px] mt-[20px] text-[#CECECE]">Whether you're a system integrator, an innovator, or a creator, our language chain framework provides the tools and capabilities you need to build and deploy Expert AI Agents™.</p>
                </div>
                {/* cards */}
                <div className="flex flex-wrap items-center gap-[28px] justify-between mt-[60px]">
                    {/* card 1 */}
                    <div className=" glass-vertical-card-1 w-[100%] md:w-[30%] lg:w-[30%] min-h-[400px]">
                        <video
                        ...
                        <h2 className="font-bold text-[20px]">Integrators</h2>
                        <p>
                            <span className="uppercase text-accent text-[18px] font-bold leading-[28px]">
                              Deliver the next era of AI-powered automation with Ground Truth®,
                            </span>
                    ...
                    {/* card 2 */}
                    <div className="glass-vertical-card-2 w-[100%] md:w-[30%] lg:w-[30%] min-h-[400px]">
                        ...
                        <h2 className="font-bold text-[20px]">Innovators</h2>
                        <p>
                         
                            <span className="uppercase text-accent text-[18px] font-bold leading-[28px]">
                                Amplify your competitive advantage with Ground Truth®,
                            </span>
                    ...
                    {/* card 3 */}
                    <div className=" glass-vertical-card-3 w-[100%] md:w-[30%] lg:w-[30%] min-h-[400px]">
                        <div className="flex items-center h-[100px]">
                            <video
                                className="mix-blend-exclusion w-[85px]"
                                muted // @ts-ignore
                        ...
                        <h2 className="font-bold text-[20px]">Creators</h2>
                        <p>
                            <span className="uppercase text-accent text-[18px] font-bold leading-[28px]">
