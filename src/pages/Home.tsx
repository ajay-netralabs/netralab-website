...
export const Home = () => {
    ...
    return (
        <div className="">
            {/* first container */}
            <div className="m-3 md:m-12 lg:m-12 mt-[80px] flex flex-col md:flex-row lg:flex-row">
                {/* texts */}
                <div className="w-full md:w-[60%] lg:w-[60%]">
                    <h1 className="text-xl lg:text-[40px] lg:leading-[66px] font-bold heading-text">Turn Human Enterprise into Expert AI Agents</h1>
                ...
                {/* graphics */}
                <div className="mt-8 md:mt-0 lg:mt-0 w-full md:w-[40%] lg:w-[40%]">
            ...
            {/* second container */}
            <div className="p-3 md:p-10 lg:p-10 second-container flex flex-col justify-center items-center md:flex-row lg:flex-row">
                <div className="w-full md:w-[60%] lg:w-[60%]">
                    <video
                    ...
                    <h1 className="text-xl lg:text-[40px] lg:leading-[66px] font-bold mt-[26px] heading-text">To simplify the complexity of Generative AI.</h1>
                    ...
                    <div className="mt-[40px] flex flex-col gap-[18px] text-[#B1B1B1]">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-base lg:text-[18px] lg:leading-[49px]">Integrate with <span className="lowercase">ANY MODEL</span>, with no limitations.</div>
                        </div>

                        <div className="flex items-center gap-3">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div className="text-base lg:text-[18px] lg:leading-[49px]">Easily craft prompts that guide your agent to <span className="lowercase"> ACT ON YOUR DATA </span>exactly as you need.</div>
                        </div>

                        <div className="flex items-center gap-3">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div className="text-base lg:text-[18px] lg:leading-[49px]">Connect and synchronize with your existing tools and systems for a <span className="lowercase">UNIFIED WORKFLOW</span>.</div>
                        </div>
                    </div>
                </div>
            ...
            {/* third container */}
            <div className="p-3 md:p-10 lg:p-10 flex flex-col justify-center items-center third-container">
                <video
                ...
                <h1 className="text-xl lg:text-[40px] lg:leading-[66px] text-center mt-[26px] font-bold heading-text">Solve Real Business Problems with Expert AI Agents™ Tailored to Your Needs</h1>
                <div className="btn btn-accent rounded-sm mt-[35px] hover:cursor-pointer" onClick={() => navigate("/contact-us")}>Request Demo</div>
                {/* cards */}
                <div className="hidden md:flex lg:flex flex-wrap w-full mt-[90px]">

                    {/* left */}
                    {/* <div className="w-[25%] flex flex-col mr-1">
                        <div className="border-b border-b-[#1F1F1F] flex justify-end">
                            <div className={`border-l border-l-[#1F1F1F] md:p-[43px] md:ml-[43px] lg:p-[43px] lg:ml-[43px]`}>
                    ...
                    {/* middle */}
                    {/* <div className="lang-card-bottom flex items-center justify-center text-center p-10 w-[70vw]">
                    ...
                    {/* <div className="w-[25%] ml-1">
                        <div className="border-b border-b-[#1F1F1F] flex justify-start">
                            <div className={`border-r border-r-[#1F1F1F] md:p-[43px] md:mr-[43px] lg:p-[43px] lg:mr-[43px]`}>
            ...
            <div className="p-3 md:p-10 lg:p-10 ">
                <div className="">
                    ...
                    <h1 className="text-xl lg:text-[40px] lg:leading-[66px] mt-[26px] font-bold heading-text">Ensure Enterprise grade reliability and governance.</h1>
                    <p className="text-base lg:text-[18px] lg:leading-[28px] mt-[20px] text-[#CECECE]">Enterprises demand security and accountability, the <span className="uppercase text-[18px] font-bold leading-[28px]">Ground Truth® Framework</span> delivers with enterprise-grade control mechanisms:</p>
                </div>
                <div className="flex items-center gap-[40px] flex-col md:flex-row lg:flex-row mt-[20px]">
                    ...
                    <div className="flex flex-col gap-[20px] text-[#CECECE] w-full md:w-[60%] lg:w-[60%] mt-[20px] md:mt-0 lg:mt-0">
                        <div className="flex items-center gap-3 glass-card-1">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div><span className="text-[18px] font-bold leading-[28px]">Enterprises demand security and accountability,</span> the Ground Truth® framework delivers with enterprise-grade control mechanisms:</div>
                        </div>
                        <div className="flex items-center gap-3 glass-card-2">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div>Our unique Validation mode enables <span className="text-[18px] font-bold leading-[28px]">the debugging and optimization</span> of your agentic workflows.</div>
                        </div>
                        <div className="flex items-center gap-3 glass-card-3">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div><span className=" text-[18px] font-bold leading-[28px]">Guarantee security by deploying</span> agents in your environment, using your data.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="p-3 md:p-10 lg:p-10">
                ...
                <video
                    ...
                    <h1 className="text-xl lg:text-[40px] lg:leading-[66px] font-bold mt-[26px] heading-text">And endless scaling possibilities for your AI Agents.</h1>
                ...
                <div className="flex justify-between mt-[20px] md:mt-0 lg:mt-0 items-center flex-col md:flex-row lg:flex-row">
                    <div className="flex flex-col gap-[20px] text-[#CECECE]  w-full md:w-[60%] lg:w-[60%] mt-[20px] md:mt-12 lg:mt-12">
                        <div className="flex items-center gap-3 glass-card-1">
                                <div className="badge badge-secondary badge-xs"></div>
                                <div><span className="text-[18px] font-bold leading-[28px]">Track your token consumption and monitor usage</span> simultaneously across all agentic workflows.</div>
                        </div>
                        <div className="flex items-center gap-3 glass-card-2">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div>
                                Extract insights from diverse sources through <span className="text-[18px] font-bold leading-[28px]"> concurrent information retrieval.</span>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 glass-card-3">
                            <div className="badge badge-secondary badge-xs"></div>
                            <div>
                                Agents that <span className=" text-[18px] font-bold leading-[28px]">operate asynchronously,</span> ensuring tasks are executed without waiting for sequential order.
                            </div>
                        </div>
                    </div>
                    <div className="w-full md:w-[40%] lg:w-[40%] flex justify-center items-center">
            ...
            <div className="p-3 md:p-10 lg:p-10">
                <div className="text-center">
                    <h1 className="text-xl lg:text-[40px] lg:leading-[66px] font-bold mt-[26px] heading-text">Built for Business</h1>
                ...
                <div className="flex flex-wrap items-center gap-[28px] justify-between mt-[60px]">
                    ...
                    <div className=" glass-vertical-card-1 w-[100%] md:w-[30%] lg:w-[30%] min-h-[400px]">
                        ...
                        <h2 className="font-bold text-[20px] heading-text">Integrators</h2>
                        <p>
                            <span className=" text-[18px] font-bold leading-[28px]">
                    ...
                    <div className="glass-vertical-card-2 w-[100%] md:w-[30%] lg:w-[30%] min-h-[400px]">
                        ...
                        <h2 className="font-bold text-[20px] heading-text">Innovators</h2>
                        <p>
                    ...
                    <div className=" glass-vertical-card-3 w-[100%] md:w-[30%] lg:w-[30%] min-h-[400px]">
                        ...
                        <h2 className="font-bold text-[20px] heading-text">Creators</h2>
                        <p>
                            <span className="text-[18px] font-bold leading-[28px]">
