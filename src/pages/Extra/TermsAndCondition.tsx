        ...
        <div className="extra-page">
            ...
            <div>
                ...
                <div className="flex flex-col table-nl">
                    ...
                    <div className="flex">
                        <p>2</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s2")}>INTELLECTUAL PROPERTY RIGHTS</p>
                    </div>
                    <div className="flex">
                        <p>3</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s3")}>USER REPRESENTATIONS</p>
                    </div>
                    <div className="flex">
                        <p>4</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s4")}>PURCHASES AND PAYMENT</p>
                    </div>
                    <div className="flex">
                        <p>5</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s5")}>PROHIBITED ACTIVITIES</p>
                    </div>
                    <div className="flex">
                        <p>6</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s6")}>USER GENERATED CONTRIBUTIONS</p>
                    </div>
                    <div className="flex">
                        <p>7</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s7")}>CONTRIBUTION LICENSE</p>
                    </div>
                    <div className="flex">
                        <p>8</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s8")}>THIRD-PARTY WEBSITES AND CONTENT</p>
                    </div>
                    <div className="flex">
                        <p>9</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s9")}>SERVICES MANAGEMENT</p>
                    </div>
                    <div className="flex">
                        <p>10</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s10")}>PRIVACY POLICY</p>
                    </div>
                    <div className="flex">
                        <p>11</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s11")}>TERM AND TERMINATION</p>
                    </div >
                    <div className="flex">
                        <p>12</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s12")}>MODIFICATIONS AND INTERRUPTIONS</p>
                    </div>
                    <div className="flex">
                        <p>13</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s13")}>GOVERNING LAW</p>
                    </div>
                    <div className="flex">
                        <p>14</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s14")}>DISPUTE RESOLUTION</p>
                    </div>
                    <div className="flex">
                        <p>15</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s15")}>CORRECTIONS</p>
                    </div>
                    <div className="flex">
                        <p>16</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s16")}>DISCLAIMER</p>
                    </div>
                    <div className="flex">
                        <p>17</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s17")}>LIMITATIONS OF LIABILITY</p>
                    </div>
                    <div className="flex">
                        <p>18</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s18")}>INDEMNIFICATION</p>
                    </div>
                    <div className="flex">
                        <p>19</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s19")}>USER DATA</p>
                    </div>
                    <div className="flex">
                        <p>20</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s20")}>ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</p>
                    </div>
                    <div className="flex">
                        <p>21</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s21")}>SMS TEXT MESSAGING</p>
                    </div>
                    <div className="flex">
                        <p>22</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s22")}>CALIFORNIA USERS AND RESIDENTS</p>
                    </div>
                    <div className="flex">
                        <p>23</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s23")}>MISCELLANEOUS</p>
                    </div>
                    <div className="flex">
                        <p>24</p>
                        <p className="hover:cursor-pointer" onClick={() => scrollTOId("s24")}>CONTACT US</p>
                    </div>
            ...
            <div id="s2">
                ...
                <p>Our Content and Marks are protected by copyright and trademark laws (and various other intellectual property rights and unfair competition laws) and treaties in the United States and around the world.
                </p>
...
solely for your internal business purpose.
                ...
                <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: info@netralabs.ai. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
...
You are solely responsible for your Submissions and you expressly agree to reimburse us for any and all losses that we may suffer because of your breach of (a) this section, (b) any third party’s intellectual property rights, or (c) applicable law.
            ...
            <div id="s5">
                ...
                <p>Systematically retrieve data or other content from the Services to create or compile, directly or indirectly, a collection, compilation, database, or directory without written permission from us.
...
Use the Services as part of any effort to compete with us or otherwise use the Services and/or the Content for any revenue-generating endeavor or commercial enterprise.</p>
            ...
            <div id="s6">
                <h1>6. USER GENERATED CONTRIBUTIONS</h1>
...
<br />Any use of the Services in violation of the foregoing violates these Legal Terms and may result in, among other things, termination or suspension of your rights to use the Services.</p>
            </div>
            <div id="s7">
                <h1>7. CONTRIBUTION LICENSE</h1>
                <p>You and Services agree that we may access, store, process, and use any information and personal data that you provide following the terms of the Privacy Policy and your choices (including settings).
            ...
            <div id="s8">
                <h1>8. THIRD-PARTY WEBSITES AND CONTENT</h1>
            ...
            <div id="s10">
                ...
                <p>We care about data privacy and security. Please review our Privacy Policy: netralabs.ai/privacy-policy. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.
                </p>
            </div>
            <div id="s11">
            ...
            <div id="s21">
            <h1>21. SMS TEXT MESSAGING</h1>
            <p>Opting Out

            <br />If at any time you wish to stop receiving SMS messages from us, simply reply to the text with "STOP.” You may receive an SMS message confirming your opt out.

            <br />Message and Data Rates

            <br />Please be aware that message and data rates may apply to any SMS messages sent or received. The rates are determined by your carrier and the specifics of your mobile plan.

            <br />Support

            <br />If you have any questions or need assistance regarding our SMS communications, please email us at info@netralabs.ai.
</p>
            </div>
            <div id="s22">
